...
namespace Wyam.Common.Tests.IO
{
    ...
    public class PathComparerTests : BaseFixture
    {
        public class EqualsMethodTests : PathComparerTests
        {
            [Test]
            [TestCase(true)]
            [TestCase(false)]
        ...
        public sealed class GetHashCodeMethodTests : PathComparerTests
        {
            [Test]
        ...
        public sealed class IsCaseSensitivePropertyTests : PathComparerTests
        {
            [Test]
            [TestCase(true)]
            [TestCase(false)]
