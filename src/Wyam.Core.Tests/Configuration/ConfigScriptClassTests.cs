...
namespace Wyam.Core.Tests.Configuration
{
    ...
    public class ConfigScriptClassTests : BaseFixture
    {
        public class GenerateMethodTests : ConfigScriptClassTests
        { 
...
{output}
        ...
        public class GenerateModuleConstructorMethodsMethodTests : ConfigScriptClassTests
        {
            [Test]
            ...
            public void GeneratesGenericConstructors()
            {
                ...
                Dictionary<string, string> memberNames = new Dictionary<string, string>();
                string expected = $@"
                        public static Wyam.Core.Tests.Configuration.ConfigScriptClassTests.GenericModule<T> GenericModule<T>(T input)
                        {{
                            return new Wyam.Core.Tests.Configuration.ConfigScriptClassTests.GenericModule<T>(input);  
                        }}
                        public static Wyam.Core.Tests.Configuration.ConfigScriptClassTests.GenericModule<T> GenericModule<T>(System.Action<T> input)
                        {{
                            return new Wyam.Core.Tests.Configuration.ConfigScriptClassTests.GenericModule<T>(input);  
                        }}";
