...
namespace Wyam.Core.Tests.Modules.Metadata
{
    ...
    public class FileNameClassTests : BaseFixture
    {
        public class ExecuteMethodTests : FileNameClassTests
        {
            ...
            public void FileNameIsConvertedCorrectly(string input, string output)
            {
                ...
                IDocument[] inputs = { new Document(engine.InitialMetadata, pipeline).Clone(new []
                {
            ...
            public void PreservesExtension()
            {
                ...
                IDocument[] inputs = 
                {
                    new Document(engine.InitialMetadata, pipeline).Clone(new []
                    {
