...
{
    // From https://github.com/aspnet/Mvc/blob/dev/src/Microsoft.AspNet.Mvc.Razor/RazorViewEngine.cs
    public class RazorViewEngine : IRazorViewEngine
    {
        ...
        /// <inheritdoc />
        public ViewEngineResult FindView(ViewContext context, string viewName)
        {
        ...
        /// <inheritdoc />
        public RazorPageResult FindPage(ViewContext context, string pageName)
        {
        ...
        /// </remarks>
        internal static string GetNormalizedRouteValue(ViewContext context, string key)
        {
            object routeValue;
