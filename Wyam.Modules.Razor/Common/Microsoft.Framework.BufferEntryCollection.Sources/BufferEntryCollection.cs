// https://github.com/aspnet/Common/blob/dev/src/Microsoft.Framework.BufferEntryCollection.Sources/BufferEntryCollection.cs
...
namespace Wyam.Modules.Razor.Microsoft.Framework.Internal
{
    /// <summary>
    ...
    internal class BufferEntryCollection : IEnumerable<string>
    {
        ...
        public void Add(char[] value, int index, int count)
        {
            if (index < 0)
            {
        ...
        public void Add(BufferEntryCollection buffer)
        {
