...
namespace Wyam.Abstractions
{
    ...
    // Content and ContentStream are guaranteed non-null for every document
    public interface IDocument : IMetadata
    {
        ...
        IDocument Clone(string source, Stream contentStream, IEnumerable<KeyValuePair<string, object>> items = null);
        IDocument Clone(Stream contentStream, IEnumerable<KeyValuePair<string, object>> items = null);
