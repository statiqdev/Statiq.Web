    ...
    internal class MetadataAs<T> : IMetadata<T>
    {
        ...
        public IEnumerator<KeyValuePair<string, T>> GetEnumerator()
        {
            return _metadata
                ...
                {
                    T value;
                    return UniversalTypeConverter.TryConvertTo(x.Value, out value)
        ...
        public int Count
        {
            get { return _metadata.Count(x => UniversalTypeConverter.CanConvertTo<T>(x.Value)); }
        }
        ...
        public bool TryGetValue(string key, out T value)
        {
            value = default(T);
            object untypedValue;
            return _metadata.TryGetValue(key, out untypedValue) && UniversalTypeConverter.TryConvertTo(untypedValue, out value);
        }
    }
}
